            ...
            <section id="introduction" class="backstretch">
                <div class="container">
                    <div class="introduction-inner various-content">
						...
						<p></p>
						<?=anchor('signup','ลงทะเบียน',' class="button submit style2" info="ลงทะเบียน" id="selectplan"');?>
						</div>
						...
						<?php echo form_close(); ?>
						 ...
						 <?=anchor('forgot_password','ลืมรหัสผ่าน',' class="button submit style1" info="ลืมรหัสผ่าน" id="selectplan"');?> <a href="../../repass/" class="submit button style1">เปลี่ยนรหัสผ่าน</a> <a href="http://172.0.0.1/" class="submit button style1">LogIn WiFi</a>
