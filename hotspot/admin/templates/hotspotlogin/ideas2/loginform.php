...
<div class="container content container-fluid" id="home">
	...
	<div class="row-fluid">
		...
		<div class="span7">
			...
			<!-- DESCRIPTION -->
			<div id="description">
								<form action="/hotspot/index.php/gologin" id="" name="form1" method="post" class="form-horizontal">
							
							 <p><input class="input-xlarge" id="username" name="UserName" type="text" placeholder="<?=$this->lang->line('username_login'); ?>"></p>
               <p><input class="input-xlarge" id="password" name="Password" type="password" placeholder="<?=$this->lang->line('password_login'); ?>">
               <input name="is_remember" checked="checked" type="checkbox" for="is_remember" title="<?=$this->lang->line('checkbox_label') ?>"></p>
                <div>
...
<div class="footer container container-fluid">
	...
	<div id="copyright">
		...
		Licensed under <a rel="license" href="http://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>. Built on <a href="https://www.facebook.com/groups/airlink.hotspot/">Airlink</a>.<br />
    <b><?=$this->lang->line('contact_2') ?></b>	{login_footer}
	</div>
	
	<!-- CREDIT - PLEASE LEAVE THIS LINK! -->
	<div id="credits">
		<a href="">Theme</a> by <a href="https://www.facebook.com/ideaslive">iDeas</a>.
	</div>
