<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets\admin\bootstrap\css\bootstrap.css') ?>">
<?php
$old_password = array(
	'name'	=> 'old_password',
	'id'	=> 'old_password',
...
?>
                    ...
                    <div class="columns">
						...
						<hr />
						<div class="clear">&nbsp;</div>	
						<div align="center"><?php echo form_submit('change', 'Change Password','class="btn btn-success"'); ?></div>
