...
class CI_Template {
   ...
   function add_js($script, $type = 'import', $defer = FALSE)
   {
      ...
      {
         case 'import':
            $filepath = base_url() . $this->config['js_path'] . $script;
   ...
   function add_css($style, $type = 'link', $media = FALSE)
   {
      ...
      $this->CI->load->helper('url');
      $filepath = base_url() . $this->config['css_path'] . $style;
   ...
   function add_themes_css($style, $type = 'link', $media = FALSE)
   {
      $this->success = TRUE;
      $css = NULL;
      
      $this->CI->load->helper('url');
      $filepath = base_url() . $this->config['theme_path'] . $style;
