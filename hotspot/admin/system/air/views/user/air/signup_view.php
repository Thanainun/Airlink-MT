            ...
            <header>
                <div class="container">
                    <div class="header-inner clearfix">
                        ...
                        <div class="branding"><a href="http://172.0.0.1/"><?=$header ?></a></div>
                        <!-- HEADER BRANDING : end -->
                         <!-- NAV TOGGLE : begin -->
...
<?=$this->form_validation->error_string;?>
	...
	<div class="widget-body"> 
                         ...
                         <a href="dashboard" class="submit button style2">เข้าสู่ระบบสมาชิก</a> <a href="http://172.0.0.1/" class="submit button style1">LogIn WiFi</a>
</div>
                                    ...
                                    <section class="various-content">
                                        ...
                                        <?=form_open($this->uri->segment(1).'/','id="form" class="validate default-form various-content" autocomplete="off"')?>
                                            ...
                                            <div class="form-fields various-content">
                                                ...
                                                <p>
													...
													<?=form_input(array('name'=>'personal_id','minlength'=>'13'),'',' title="'.$this->lang->line('register_personal_id').'" id="personal_id" placeholder='.$this->lang->line('register_personal_id').'')?>
                                                </p>
										...
										?>
                                               ...
                                               <?=form_input('province','','type="text" placeholder='.$this->lang->line('register_city').'')?>
                                                ...
                                                <p>
                                                <button class="submit button style2" type="reset"><?=$this->lang->line('register_clear'); ?></button>
												&nbsp; <button class="submit button style1" type="submit"><?=$this->lang->line('register_submit'); ?></button>
												&nbsp; <a href="dashboard" class="submit button style2"><?=$this->lang->line('register_submit1'); ?></a>
                                                </p>
                                            </div>
                                            <!-- FORM FIELDS : end -->
