...
<? if ($complate) { ?>
                    ...
                    <div class="columns leading"> 
                        <div class="grid_5 first">
							...
							<div  class="message info" align="center">
                                ...
                                <p>หากมีปัญหาการเติมเวลาติดต่อ ผู้ดูแลระบบ.</p>
							</div>
                        </div>
                    </div>
	...
	<? } else {?>
                    ...
                    <div class="columns">
						...
						<header><div class="login-hd">ระบบเครียผู้ใช้งานที่ค้างในระบบ  WIFI</div></header>
						<hr />
							<center>
							  <p>แก้ไขปัญหาผู้ใช้ค้างในระบบ (มีการล็อกอินหรือยังไม่ออกจากระบบมาจากเครื่องอื่น)ย้ายไปเล่นเครื่อใหนก็ได้ไม่ต้องรอถึง10นาที ระบบนี้สามารถเครียให้ท่านได้ หรือติดต่อ ผู้ดูแลระบบ </p>
						  </center>
						...
						<table width="25%" class="full">
							<tr>
							  <td width="2%"  rowspan="2">&nbsp;</td>
								...
								<td width="61%"><?=form_input(array('name'=>'user','type'=>'text','minlength'=>'4'),'',' title="ชื่อผู้ใช้เดิมที่จะเติม" required="required" id="user"')?></td>
						    </tr>
