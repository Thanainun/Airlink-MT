    ...
    <div class="widget_container">
                    ...
                    <h4>ข้อมูลสถิติรายได้/การเติมเงิน</h4><?=$show;?>
                       ...
                       <hr />
							...
							<div align="right">						
ค้นหา จากวันที่ :
<input onClick="javascript: NewCssCal('start','yyyyMMdd','dropdown');" value "$start" name="start"  type="text" id="start"/>
ถึง วันที่ :<input onClick="javascript: NewCssCal('end','yyyyMMdd','dropdown');" value "$end" name="end" type="text" id="end"/>
