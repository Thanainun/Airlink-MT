                                    ...
                                    <section class="various-content">
										...
										?>
                                               ...
                                               <?=form_input('province','','type="text" placeholder='.$this->lang->line('register_city').'')?>
                                                ...
                                                <button class="submit button style2" type="reset"><?=$this->lang->line('register_clear'); ?></button> </div>
                                                <div class="span6"><button class="submit button style1" type="submit"><?=$this->lang->line('register_submit'); ?></button></div></div>
