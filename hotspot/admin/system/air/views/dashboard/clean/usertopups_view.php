    ...
    <div id="coming_soon">
        <div class="head">
            <div class="container">
                ...
                <div>
                        <h2><strong><?=$this->lang->line('user_pages_head') ?></strong> <span><?=$this->lang->line('user_pages_head2') ?></h2>
				</div>	
				<div class="span4 text">
						<h2></span> <span class="right"><?=$this->lang->line('user_amount'); ?> : <?=number_format($user->money,$this->config->item('decimal_places'),$this->config->item('decimal_separator'),$this->config->item('thousands_separator'))?>  <?=$this->lang->line('user_currency')?></span></h2>
                 </div>     
