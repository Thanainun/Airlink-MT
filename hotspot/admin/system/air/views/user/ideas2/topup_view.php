...
<? if ($complate) { ?>
	...
	<? } else {?>
                    ...
                    <div class="columns">
						...
						<hr />
							<center><p>ท่านสามารถ เติมเวลาให้ รหัสเก่าของท่าน ด้วยบัตร  WIFI ท่านสมมารถหาซื้อได้ที่ ตัวแทนจำหน่าย </p></center>
						...
						<table width="25%" class="full">
							<tr>
							  <td width="2%" ></td>
								<td width="37%" ></td>
								<td width="61%" align="left"><div style="color:red;" rel="reply" class="total_members"><img src="https://192.168.50.254/admin/upload/card/001.png" width="109" height="38" />
							    <?=$error?></div></td>
						    </tr>
							<tr>
							  <td  rowspan="2">&nbsp;</td>
						...
						<table width="25%" class="full">
                              <tr>
                                <td width="2%" ></td>
                                <td width="37%" ></td>
                                <td width="61%" align="left"><div style="color:red;" rel="reply" class="total_members"><span class="total_members" style="color:red;"><img src="https://192.168.50.254/admin/upload/card/001.png" alt="" width="109" height="38" /></span><span class="total_members" style="color:red;">
                                  <?=$error2?>
                                </span></div></td>
                          </tr>
                              <tr>
